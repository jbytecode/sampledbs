...
Number of Non-empty cells in a given range.
...
\subsection{COUNTBLANK}

Number of empty cells in a given range.
...
Number of cells in a given range that satisfy a given condition.
